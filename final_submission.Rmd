...
My research question is: what aspects of an album contributed to a ranking on the 2020 Rolling Stones' 'The 500 Greatest Albums of All Time'?

I hypothesize that such a factor was Spotify popularity, which was novel in 2020 compared to 2012. Other than Spotify popularity, I will check weeks spent on Billboard, years between debut and top 500 album, release year and album type as predictors of a top 500 ranking in 2020.
...
Finally, the relationship of ranking differential between 2020-2003 and album type will be investigated. I hypothesize that album type did not effect the ranking in 2020, but it influenced the ranking differential over time.
...
#Change NA's in spotify_popularity and weeks_on_billboard to be able to use it in models
